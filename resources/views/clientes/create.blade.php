        ...
        <div class="d-flex gap-3 w-75 p-4">
            ...
            <div class="col-3 bg-transparent">
                <ul class="list-group list-group-flush">
                    <li id="paso-item-1" class="list-group-item border-0 thisPaso rounded shadow-sm">
                        <small class="fw-normal">PASO 1</small>
                        <div class="titulo">INFORMACION GENERAL</div>
                    </li>
                    <li id="paso-item-2" class="list-group-item border-0 bg-transparent text-muted">
            ...
            @csrf
                <div id="paso_1" class="col">
                    ...
                    <div class="d-flex justify-content-between gap-3">
                        ...
                        <button type="button" class="btn btn-primary flex-fill" onclick="nextStep()">Siguiente</button>
                    </div>
                </div>
                <div id="paso_2" class="col" style="display:none;">
                    ...
                    <!-- botones -->
                    <div class="d-flex justify-content-between gap-3">
                        <button type="button" class="btn btn-light flex-fill border" onclick="prevStep()">Regresar</button>
