...
<div class="col px-5">
    ...
    <div class="d-flex justify-content-center">
        <div class="row w-75 p-4">
            ...
            <div class="col-md-8">
                <!-- formulario -->
                <form method="POST" action="{{ route('productos.index') }}" class="shadow-sm bg-white p-4 rounded">
                    @csrf
                    <!-- precio -->
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-between gap-3">
                        <button type="button" class="btn btn-light flex-fill border" 
                            onclick="window.location.href='{{ route('productos.create.monetaria') }}'">Regresar</button>
