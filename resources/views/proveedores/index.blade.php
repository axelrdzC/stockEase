            ...
            <div class="d-flex p-0 gap-2">
                <form class="d-flex position-relative w-100" role="search">
                    <input class="form-control border-secondary px-4 p-2 bg-white border-0 shadow-sm" 
                        type="search" placeholder="Busca algun proveedor" aria-label="Search">
                    ...
                    <div class="card shadow-sm bg-white border-0 m-0">
                        <div class="card-body d-flex align-items-center">
                            <div class="d-flex flex-column w-50">
                                <h1 class="fs-5 fw-bold">{{ $proveedor->id }}. {{ $proveedor->nombre }}</h1>
                            </div>
                            <div class="d-flex flex-grow-1">
                                <div class="col-4">
                                    <small class="row">Correo</small>
                                    <small class="row fs-6 fw-bold">$ {{ $proveedor->correo }}</small>
                                </div>
                                <div class="col-4">
