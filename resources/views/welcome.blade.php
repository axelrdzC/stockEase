...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container-fluid d-flex flex-column justify-content-center align-items-center vh-100 position-relative">
            <div class="text-center">
                <img src="img/welcome-guy.png" alt="just the welcome guy" class="position-relative img-fluid mx-auto d-block z-1" style="max-width: 35%;">
                <div class="welcome-txt text-nowrap position-absolute top-50 start-50 translate-middle z-0">    
            ...
            <div class="mt-4 text-center">
                <p>Por favor, acceda a alguna de las opciones de arriba para obtener acceso al almacén</p>
                @if (Route::has('login'))
                    ...
                    <a href="{{ url('/dashboard') }}" class="btn btn-primary col-4 z-2"> Dashboard </a>
                        ...
                        <a href="{{ route('login') }}" class="btn btn-primary col-4 z-2"> Log in </a>
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="btn btn-primary col-4 z-2"> Register </a>
                            @endif
                    @endauth
                    </div>
                @endif
